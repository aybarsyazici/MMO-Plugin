...
public class PathfinderAttackOwnersTargetWhileRiding extends PathfinderGoal
{
    ...
    public PathfinderAttackOwnersTargetWhileRiding(EntityInsentient a, Necromancer.Summon summon, EntityLiving target, float distance)
    {
        this.a = a;
        this.target = target;
        this.g = distance;
    ...
    public boolean a()
    {
        ...
        if(!target.isAlive())
            return false;
        return target != summon.getRidingSummon();
    }
